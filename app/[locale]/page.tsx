...
export default function HomePage() {
  return (
    <section className="relative min-h-[calc(100dvh-140px)] overflow-hidden bg-background">
      ...
      <div className="relative mx-auto grid min-h-[calc(100dvh-140px)] w-full max-w-7xl gap-6 px-4 py-6 md:px-6 md:py-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <HeroTriangle />
